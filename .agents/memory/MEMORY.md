...
- [Vehicle detail route unification](vehicle-detail-route-unification.md) — Client vehicle entry points previously used both `/client/device/:id` and `/client/vehicle/:id`; `/client/vehicle/:id` is now the official route to `DeviceDetail.jsx`. No backend, Traccar, database, or API changes; build passed.
