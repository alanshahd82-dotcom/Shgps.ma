...
-- Creates all core tables. Idempotent (safe to run on existing DBs).
-- ═══════════════════════════════════════════════════════════════════════
...
VALUES ('admin@athar-gps.ma', '$2b$10$ZvUexuJI0dAHaSm6hq2jZOPjS5wlvvIHLywBCz.8hK72GQSMu2z1m', 'مدير النظام', true, 'م')
